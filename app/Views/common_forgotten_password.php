                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?php echo base_url('common/login/forgotten_password'); ?>" autocomplete="off">
                                        <div class="form-group">
                                        <input type="email" class="mb-4 form-control form-control-user" id="email" name="email" placeholder="Saisir adresse email" autofocus />
                                        </div>
                                        <input type="submit" class="mb-4 btn btn-primary btn-user btn-block" value="Envoyer" />
                                    </form>
                                    <hr>
                                    <div class="text-center">
